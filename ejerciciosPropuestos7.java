...
public class ejerciciosPropuestos7 {

	public static void main(String[] args) {
// Ejercicio: Realiza un programa que transforme números en formato decimal a números en formato romano (hasta el número 3999 como máximo)
